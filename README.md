...
## Environments
- Preview: https://main--maji-da-25--aemysites.aem.page/
- Live: https://main--maji-da-25--aemysites.aem.live/
- Block Library: https://main--maji-da-25--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `maji-da-25` directory in your favorite IDE and start coding :)
